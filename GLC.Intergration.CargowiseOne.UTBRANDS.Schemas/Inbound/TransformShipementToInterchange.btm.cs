namespace GLC.Intergration.CargowiseOne.UTBRANDS.Schemas.Inbound {
    ...
    public sealed class TransformShipementToInterchange : global::Microsoft.XLANGs.BaseTypes.TransformBase {
...
<xsl:stylesheet xmlns:xsl=""http://www.w3.org/1999/XSL/Transform"" xmlns:msxsl=""urn:schemas-microsoft-com:xslt"" xmlns:var=""http://schemas.microsoft.com/BizTalk/2003/var"" exclude-result-prefixes=""msxsl var userCSharp"" version=""1.0"" xmlns:ns0=""http://www.cargowise.com/Schemas/Universal/2011/11"" xmlns:userCSharp=""http://schemas.microsoft.com/BizTalk/2003/userCSharp"">
  ...
  <xsl:template match=""/ns0:UniversalShipment"">
    ...
    <!--Prod Value-->
    <xsl:variable name=""var:v1"">GLCLAX</xsl:variable> 
    <xsl:variable name=""var:v2"">GLCGDSLAX</xsl:variable>
    <xsl:variable name=""var:v3"">OnAll</xsl:variable>
    <xsl:variable name=""var:v4"">eAdaptor</xsl:variable>
    <xsl:variable name=""var:v5"">GLCGDSLAX</xsl:variable>
        ...
        <ns0:Acknowledgement>
          ...
          <ns0:ContextCollection>
            <ns0:Context>
              ...
              <ns0:Value>UTB</ns0:Value>
            </ns0:Context>
            <ns0:Context>
              <ns0:Type>MESSAGE_IDENTIFIER</ns0:Type>
              <ns0:Value>UTBrand</ns0:Value>
            </ns0:Context>
            <ns0:Context>
