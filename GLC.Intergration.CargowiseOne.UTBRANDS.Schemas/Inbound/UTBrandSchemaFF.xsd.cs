namespace GLC.Intergration.CargowiseOne.UTBRANDS.Schemas.Inbound {
    ...
    [Schema(@"http://GLC.Intergration.CargowiseOne.UTBRANDS.Schemas.Inbound.UTBrandSchemaFF",@"UTBrandFF")]
    [System.SerializableAttribute()]
    [SchemaRoots(new string[] {@"UTBrandFF"})]
    public sealed class UTBrandSchemaFF : Microsoft.XLANGs.BaseTypes.SchemaBase {
...
<xs:schema xmlns=""http://GLC.Intergration.CargowiseOne.UTBRANDS.Schemas.Inbound.UTBrandSchemaFF"" xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" targetNamespace=""http://GLC.Intergration.CargowiseOne.UTBRANDS.Schemas.Inbound.UTBrandSchemaFF"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:annotation>
    <xs:appinfo>
    ...
    <xs:complexType>
      <xs:sequence>
        ...
        <xs:element maxOccurs=""unbounded"" name=""OrderLines"">
          <xs:annotation>
            <xs:appinfo>
              <b:recordInfo structure=""delimited"" child_delimiter_type=""char"" child_delimiter="","" child_order=""prefix"" sequence_number=""2"" preserve_delimiter_for_empty_data=""true"" suppress_trailing_delimiters=""false"" />
            </xs:appinfo>
          </xs:annotation>
          <xs:complexType>
            <xs:sequence>
