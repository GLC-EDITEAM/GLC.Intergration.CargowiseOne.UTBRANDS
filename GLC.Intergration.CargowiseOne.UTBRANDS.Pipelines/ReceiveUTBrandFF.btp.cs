namespace GLC.Intergration.CargowiseOne.UTBRANDS.Pipelines
{
    ...
    public sealed class ReceiveUTBrandFF : Microsoft.BizTalk.PipelineOM.ReceivePipeline
    {
...
"       <Value xsi:type=\"xsd:string\">GLC.Intergration.CargowiseOne.UTBRANDS.Schemas.Inbound.UTBrandSc"+
"hemaFF, GLC.Intergration.CargowiseOne.UTBRANDS.Schemas, Version=1.0.0.0, Culture=neutral, PublicKeyT"+
"oken=171a46e7ea1c8102</Value>            </Property>            <Property Name=\"TrailerSpecName\" /> "+
"           <Property Name=\"PreserveHeader\">              <Value xsi:type=\"xsd:boolean\">false</Value>"+
"            </Property>            <Property Name=\"ValidateDocumentStructure\">              <Value x"+
"si:type=\"xsd:boolean\">false</Value>            </Property>            <Property Name=\"RecoverableInt"+
"erchangeProcessing\">              <Value xsi:type=\"xsd:boolean\">false</Value>            </Property>"+
"          </Properties>          <CachedDisplayName>Flat file disassembler</CachedDisplayName>      "+
...
"/>    </Stage>  </Stages></Document>";
        ...
        private const string _versionDependentGuid = "e90c656d-a2fb-45e4-b1d5-fc2e83be343a";
        
        public ReceiveUTBrandFF()
        {
...
" />    <Property Name=\"DocumentSpecName\">      <Value xsi:type=\"xsd:string\">GLC.Intergration.Cargowi"+
"seOne.UTBRANDS.Schemas.Inbound.UTBrandSchemaFF, GLC.Intergration.CargowiseOne.UTBRANDS.Schemas, Vers"+
"ion=1.0.0.0, Culture=neutral, PublicKeyToken=171a46e7ea1c8102</Value>    </Property>    <Property Na"+
